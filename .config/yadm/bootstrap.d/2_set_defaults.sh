...
system_dock_layout() {
    ...
    dock_app_set pos=5  desktop=  path="/Applications/Obsidian.app"
    ...
    dock_app_set pos=9  desktop=3 path="/System/Applications/Messages.app"
    dock_app_set pos=10 desktop=3 path="/System/Applications/Contacts.app"
